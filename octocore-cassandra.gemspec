require File.expand_path('../lib/octocore-cassandra/version', __FILE__)

Gem::Specification.new do |s|
  s.name        = 'octocore-cassandra'
  s.version     = Octo::VERSION

  s.summary     = 'Octo Enterprise Core Modules for Cassandra'
  s.description = <<DESC
...
DESC
  ...
  s.executables << 'fakestream-cassandra'
  s.executables << 'octocore-admin-cassandra'

  s.homepage    =
    'https://github.com/octoai/gem-octocore-cassandra'
  s.license       = 'MIT'
