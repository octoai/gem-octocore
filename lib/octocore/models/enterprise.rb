...
module Octo
  ...
  module Cassandra
    class Enterprise
      ...
      has_many :users, class_name: 'Octo::Cassandra::User'
      has_many :segments, class_name: 'Octo::Cassandra::Segment'
      has_many :templates, class_name: 'Octo::Cassandra::Template'
      has_many :funnels, class_name: 'Octo::Cassandra::Funnel'
      has_many :conversions, class_name: 'Octo::Cassandra::Conversions'
      ...
      def setup_notification_categories
        ...
        if templates
          templates.each do |t|
            ...
            Octo::Cassandra::Template.new(args).save!
          end
      ...
      def setup_intelligent_segments
        ...
        if segments
          segments.each do |seg|
            ...
            Octo::Cassandra::Segment.new(args).save!
          end
