  ...
  module Cassandra
    ...
    class Conversions
      ...
      class << self
        ...
        def types
          {
            'Newsfeed' => Octo::Cassandra::Conversions::NEWSFEED,
            'Notification' => Octo::Cassandra::Conversions::PUSH_NOTIFICATION,
  #          'Email' => Octo::Cassandra::Conversions::EMAIL
          }
        end
        ...
        def data( enterprise_id, type, ts = 3.days.ago..Time.now.floor)
          ...
          if res.count > 0
            ...
            res = []
            e = Octo::Cassandra::Enterprise.find_by_id(enterprise_id)
            if e.fakedata?
              if ts.class == Range
